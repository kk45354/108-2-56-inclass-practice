...
```{r ans22}
#str(course)
course_update <- course           #為了不要動到原本的資料
...
```{r ans32}
as.numeric(c(Pikachu$baseStats$atk, Pikachu$baseStats$def, Pikachu$baseStats$hp)) -> Pikachu_stats
# Pikachu_stats
```
...
Gamemaster$pokemon[[46]] -> Jigglypuff          #注意箭頭方向
...
Mimikyu <- list(dex=778, speciesName="Mimikyu", speciesId="mimikyu", basitypes=c("ghost","fairy"))
