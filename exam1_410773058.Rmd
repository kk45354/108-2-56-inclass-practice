...
```{r ans32}
post$comments$gender <- as.character(post$comments$gender)
...
```{r ans33}
post$comments$DateTime <- ymd_hms(post$comments$DateTime, tz="Asia/Taipei")
...
post$comments$DateTime[[26]] <- with_tz(ymd_hms("2020-04-25 15:50:00", tz="Europe/Warsaw"), tzone = "Asia/Taipei")
...
```{r ans35}
strsplit(post$category_dateTime,"_")
